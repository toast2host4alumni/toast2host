...
export interface ApiConnectionEventConnectionEvent
  extends Struct.CollectionTypeSchema {
  collectionName: 'connection_events';
  info: {
    displayName: 'Connection Event';
    pluralName: 'connection-events';
    singularName: 'connection-event';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::connection-event.connection-event'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPrivacyRequestPrivacyRequest
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['open', 'completed']> &
      Schema.Attribute.DefaultTo<'open'>;
    type: Schema.Attribute.Enumeration<['deletion', 'export']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    plan_tier: Schema.Attribute.String & Schema.Attribute.DefaultTo<'free'>;
    publishedAt: Schema.Attribute.DateTime;
    source: Schema.Attribute.Enumeration<['manual', 'usage_rule']> &
...
export interface ApiUserProfileUserProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    location_text: Schema.Attribute.String & Schema.Attribute.Required;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    university_external_id: Schema.Attribute.String;
    university_name: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::connection-event.connection-event': ApiConnectionEventConnectionEvent;
